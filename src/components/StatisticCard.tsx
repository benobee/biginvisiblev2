...
const StatisticCard = ({ 
  ...
  }, [statistic.percentage, hasAnimated]);
  const getVariantClasses = () => {
    switch (variant) {
      ...
      default:
        return {
          container: 'bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300 h-64',
  ...
  return (
    <div className={`${classes.container} ${className} reveal-text`}>
